...
func TestParseBangs(t *testing.T) {
	tests := []struct {
		...
		{
			input:       "!wl diplomatic cables",
			defaultCat:  models.CategoryGeneral,
			expectedQ:   "diplomatic cables",
			expectedCat: models.CategoryGeneral,
			expectedEng: "wikileaks",
		},
		{
			input:       "!ransom victim leak",
			defaultCat:  models.CategoryGeneral,
			expectedQ:   "victim leak",
			expectedCat: models.CategoryGeneral,
			expectedEng: "ransomware",
		},
		{
			input:       "!tg osint dump",
			defaultCat:  models.CategoryGeneral,
			expectedQ:   "osint dump",
			expectedCat: models.CategoryGeneral,
			expectedEng: "telegram_leaks",
		},
		{
			input:       "!exploit zero day buffer overflow",
			defaultCat:  models.CategoryGeneral,
			expectedQ:   "zero day buffer overflow",
			expectedCat: models.CategoryGeneral,
			expectedEng: "exploits",
		},
		{
			input:       "!sploitus! CVE-2024-1234",
			defaultCat:  models.CategoryGeneral,
			expectedQ:   "CVE-2024-1234",
			expectedCat: models.CategoryGeneral,
			isDirect:    true,
		},
		{
